...
endpoint = "http://localhost:8502/v1/models/potatoes_model:predict" # use the latest endpoint (version) for TensorFlow Serving
...
async def predict(
    ...
    prediction = np.array(response.json()["predictions"][0]) #get the first prediction from the list
